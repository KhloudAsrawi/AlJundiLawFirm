<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderWebsite.Master" AutoEventWireup="true" CodeBehind="AnsweredConsultations.aspx.cs" Inherits="AlJundiLawFirm.LegalAdvice.AnsweredConsultations" %>
...
<div id="DivAnsweredConsultations" runat="server">
    <div id="DivAnswered" runat="server">
    </div>
    <div class="container-md mt-3" id="DivNumberPages" runat="server" visible="false">                 
    </div>
</div>

<%-- الاستشارات لا يوجد للان استشارات اجبت عليها --%>
<div id="DivNoAnsweredConsultations" runat="server" class="container-md StyleBox StyleColumn" visible="false" style="direction:rtl">
    <div class="mb-3 mt-3 text-center">
        <br />
        <asp:Label ID="Label1" runat="server" Text="لم تقم بالاجابة على اي استشارة للان..."></asp:Label>
        <br />
    </div>
    <div class="mb-3 mt-3 text-center">
        <div class="row">
