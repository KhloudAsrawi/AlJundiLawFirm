<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderWebsite.Master" AutoEventWireup="true" CodeBehind="CounselingPublic.aspx.cs" Inherits="AlJundiLawFirm.LegalAdvice.CounselingPublic" %>
...
<br />
<%-- الاستشارات العامة --%>
<div id="DivConsultations" runat="server">
    <div id="DivConsultation" runat="server">
    </div>
    <div class="container-md mt-3" id="DivNumberPages" runat="server" visible="false">                 
    </div>
</div>

<%-- لا توجد الاستشارات العامة --%>
<div id="DivNoConsultations" runat="server" class="container-md StyleBox StyleColumn" visible="false" style="direction:rtl">
    <div class="mb-3 mt-3 text-center">
        <br />
        <asp:Label ID="Label1" runat="server" Text="ليس هناك اي استشارات ممكن عرضها"></asp:Label>
        <br />
    </div>
    <div class="mb-3 mt-3 text-center">
        <div class="row">
