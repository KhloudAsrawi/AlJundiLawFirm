...
{
    public partial class NewConsultations : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Page.Title = "الجندي للاستشارات القانونية - الاستشارات الجديدة";
            ...
            try
            {
                ...
                if (ListPermission != null && ListPermission.Count > 0)
                {
                    ...
                    if (ViewAnsweredConsulting == true)
                    {
                        ...
                        float NumberAnsweredConsultations = Statistics.NumberConsultationsNotAnswered();
                        ...
                        // VCNA mean Fetch Conversations people not have Answers
                        List<ViewConsultationsAnswers> VCNA = ViewConsultationsAnswers.ViewListConsultationsNoAnswers(rang);  // ViewConsultationsAnswers.ViewListConsultationsAnswers(Id_User, rang);
