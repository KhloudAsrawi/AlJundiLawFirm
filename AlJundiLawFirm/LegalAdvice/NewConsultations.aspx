<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderWebsite.Master" AutoEventWireup="true" CodeBehind="NewConsultations.aspx.cs" Inherits="AlJundiLawFirm.LegalAdvice.NewConsultations" %>
...
<%-- لا توجد استشارات جديدة للاجابة عليها --%>
<div id="DivNoAnsweredConsultations" runat="server" class="container-md StyleBox StyleColumn" visible="false" style="direction:rtl">
    <div class="mb-3 mt-3 text-center">
        <br />
        <asp:Label ID="Label1" runat="server" Text="لا توجد استشارات جديدة للاجابة عليها"></asp:Label>
        <br />
    </div>
    <div class="mb-3 mt-3 text-center">
        <div class="row">
